		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Report",
									"targetURL": "#brcomgestaofioriappreport237-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brcomgestaofioriappreport237-display": {
								"semanticObject": "brcomgestaofioriappreport237",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.gestao.fioriappadmin237",
									"url": sap.ui.require.toUrl("br/com/gestao/fioriappadmin237")
								}
							}
						}
					}
